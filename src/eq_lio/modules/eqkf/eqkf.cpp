#include "eq_lio/modules/ieskf/ieskf.h"
#include "eq_lio/math/SO3.h"
using namespace liepp;
namespace EQLIO
{
    EQKF::EQKF(const std::string & config_path,const std::string &prefix):ModuleBase(config_path,prefix,"EQKF")
    {
        P.setIdentity();
    ...
    void EQKF::predict( IMU &imu,double dt){
    ...
    Eigen::Matrix<double,18,1> EQKF::getErrorState18(const State18 &s1, const  State18 &s2){
    ...
    const EQKF::State18&EQKF::getX(){
        return X;
    }
    void EQKF::setX(const EQKF::State18&x_in){
        X = x_in;
    }
} // namespace EQLIO
